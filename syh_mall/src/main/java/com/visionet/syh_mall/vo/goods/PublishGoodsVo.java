...
public class PublishGoodsVo {
	...
	public String toString() {
		return "PublishGoodsVo [goodsDraftID=" + goodsDraftID + ", goodsName=" + goodsName + ", goodsTypeCode="
